...
const Header = () => {
  ...
  return (
    <header className="absolute top-0 left-0 w-full px-4 sm:px-6 lg:px-24 py-6 border-b border-white flex justify-between items-center z-50">
      {/* Logo */}
      ...
      `}>
        ...
        <nav className="flex flex-col items-center space-y-8 mt-16">
          <a href="#" onClick={toggleMobileMenu} className="text-white text-xl font-semibold leading-6 hover:underline">Home</a>
          <a href="#" onClick={toggleMobileMenu} className="text-white text-xl font-semibold leading-6 hover:underline">About Us</a>
          <a href="#" onClick={toggleMobileMenu} className="text-white text-xl font-semibold leading-6 hover:underline">Pages</a>
