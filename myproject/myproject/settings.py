...
ALLOWED_HOSTS = ['localhost', '127.0.0.1','https://work2-vn12.onrender.com','.onrender.com','https://agriintell.netlify.app/']
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'contact_app',  # Add corsheaders to installed apps for CORS support
